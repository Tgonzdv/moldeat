...
<body>
    <div class="main-container">
        ...
        <div class="text-center">
            <button class="btn btn-comenzar" onclick="comenzarJuego()">
                Comenzar
            </button>
        </div>
    </div>
    ...
    <script>
        ...
        document.querySelector('.btn-comenzar').addEventListener('mouseenter', function() {
